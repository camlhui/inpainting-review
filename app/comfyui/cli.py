import click
from comfyui.server import (
    start as start_server,
    stop as stop_server,
    flush as flush_gpu_memory,
)
from comfyui.workflows import run_workflow
...
@cli.command()
@click.argument("name", help="Name of the inpainting workflow to use.")
@click.argument("image-path", help="Path to the input image file.")
@click.argument("mask-path", help="Path to the mask image file.")
@click.argument("output-path", help="Path to save the output image.")
